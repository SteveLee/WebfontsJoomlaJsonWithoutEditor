...
class WebfontsBaseModelWebfontsConfigure extends JModel
{
	...
	function &getFonts($project_key = null)
	{
		...
		$apiurl = "json/Fonts/?wfscp=0&wfsplimit=".FONT_LIMIT."&wfspid=".$project_key;
	...
	*/
	function wfs_font_list_pagination($pid=null){
		...
		$wfs_details = getUnPass();
		//fetch json data from WFS
		$apiurl = "json/Fonts/?wfscp=".$pageStart."&wfsplimit=".FONT_LIMIT."&wfspid=".$_GET['pid'];
		$wfs_api = new Services_WFS($wfs_details[1],$wfs_details[2],$apiurl);
		$jsonUrl = $wfs_api->wfs_getInfo_post();
		//Creating JSON Instance
		$json = new Services_JSON(SERVICES_JSON_LOOSE_TYPE);
	...
	function &getSelectorsList($project_key = null){
		...
		$apiurl = "json/Selectors/?wfscp=".$pageStart."&wfsplimit=".SELECTOR_LIMIT."&wfspid=".$project_key;
		$wfs_api = new Services_WFS($wfs_details[1],$wfs_details[2],$apiurl);
		$jsonUrl = $wfs_api->wfs_getInfo_post();
	 ...
	 */
	 function add_selector(){
		...
		$apiurl = "json/Selectors/?wfscp=0&wfsplimit=".SELECTOR_LIMIT."&wfspid=".$project_key;
		$wfs_api = new Services_WFS($wfs_details[1],$wfs_details[2],$apiurl);
	...
	*/
	function &getDomains($project_key = null){
		...
		$wfs_details = getUnPass();
		//Fetching the json data from WFS
		$apiurl = "json/Domains/?wfscp=".$pageStart."&wfsplimit=".DOMAIN_LIMIT."&wfspid=".$project_key;
		$wfs_api = new Services_WFS($wfs_details[1],$wfs_details[2],$apiurl);
		$jsonUrl = $wfs_api->wfs_getInfo_post();
		$json = new Services_JSON(SERVICES_JSON_LOOSE_TYPE);
	...
	*/
	function addDomain(){
		...
		//Fetching the json data from WFS
		$apiurl = "json/Domains/?wfscp=0&wfsplimit=".DOMAIN_LIMIT."&wfspid=".$project_key;
		$wfs_api = new Services_WFS($wfs_details[1],$wfs_details[2],$apiurl);
